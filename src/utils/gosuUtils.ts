...
export class GosuUtils {
    
    /**
     * Check if a string contains GOSU keywords
     */
    static containsGosuKeywords(text: string): boolean {
        const keywords = [
     ...
     */
    static extractClassNames(text: string): string[] {
     ...
     */
    static extractFunctionNames(text: string): string[] {
     ...
     */
    static isGosuFile(fileName: string): boolean {
